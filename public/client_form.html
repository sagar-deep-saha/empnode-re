...
<body class="form-v10">
	<nav>
		...
		<form class="search" action="client_form.html?#" method="get">
			<input type="text" placeholder="Type to Search" class="my" />
			<button type="submit" class="ui"> <img src="images/ser.png" class="log2"></button>
		</form>
		<div class="d7">
			<a href="http://wa.me/+918258026940" target="_blank">
	...
	<div class="page-content">
		<div class="form-v10-content">
			<form class="form-detail" action="client_form-load.php" method="post" id="myform">
				<div class="form-left">
				...
				<div class="form-right">
					...
					<div class="form-checkbox">
						<label class="container">
							<p>I do accept the <a href="client_tnc.html" class="text">Terms and Conditions</a> of your site.</p>
							<input type="checkbox" name="checkbox">
							<span class="checkmark"></span>
						</label>
					</div>
					<div class="form-row-last">
						<input type="submit" name="register" class="register" value="Register Empnode">
					</div>
				</div>
			</form>
		</div>
	...
	<footer class="footer">
		<div class="top">
			<div class="content">
				...
				<p>
					India's Largest Employeers Tool for managing small to Large scale Companies within a Secure
					Environment
				</p>
			</div>
			<div class="links">
		...
		<div class="bottom">
			<p>Copyright © 2010-2023 Empnode All rights reserved.</p>
		</div>
	</footer>
</body>
</html>